...
export function parseHumanReadableTime(input) {
...
export function parseHumanReadableSize(input) {
...
export async function run() {
    try {
        ...
        const maxTotalSizeInput = core.getInput("max-total-size", {
            required: false
        });
        const accessed = core.getInput("accessed", {
            required: false
        }) === "true";
        const created = core.getInput("created", {
            required: false
        }) === "true";
